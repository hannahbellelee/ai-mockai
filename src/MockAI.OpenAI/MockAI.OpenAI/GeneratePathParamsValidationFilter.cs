...
namespace IO.Swagger.Filters
{
    ...
    /// Original generated file :$\MockAI\src\MockAI.OpenAI\Filters\GeneratePathParamsValidationFilter.cs
    /// </summary>
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            foreach (var par in pars)
            {
                ...
                if (parameterDescriptor is not null)
                {
                    ...
                    var attributes = parameterDescriptor.ParameterInfo.CustomAttributes;
